        ...
        <div className="mx-auto flex h-14 max-w-[1400px] items-center justify-between px-4">
          <div className="flex items-center gap-8">
            ...
            <nav className="hidden md:flex items-center gap-6">
              ...
              <span className="text-sm font-medium text-muted-foreground hover:text-foreground cursor-default transition-colors duration-200">Templates</span>
              <span className="text-sm font-medium text-muted-foreground hover:text-foreground cursor-default transition-colors duration-200">Examples</span>
            </nav>
          </div>
